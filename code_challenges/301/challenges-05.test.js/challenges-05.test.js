...
// forEach is not working here, any idea why? What am I doing wrong?!
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach( (item) => {
    let amount = item.indexOf(' ');
    let units = item.indexOf(' ', amount+1);
    result.push(item.slice(units+1));
  })
  return result;
};


//For reference: https://www.w3schools.com/jsref/jsref_indexof.asp
...
//Cannot get this one to pass the tests! What am I doing wrong here!?
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const extractVowels = (str) => {
  ...
  return [noVowels.join(''), vowels.sort().join('')];
};
